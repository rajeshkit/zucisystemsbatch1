<%@ page import="zuci.rms.model.Restaurant,java.util.List" language="java" contentType="text/html; charset=ISO-8859-1"
...
<html lang="en">
  ...
  <tbody>
  <c:forEach var="restaurant" items="${requestScope.rest}">
    <tr>
      <th scope="row">1</th>
